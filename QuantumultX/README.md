...
### QuantumultX
```
# 在 QuantumultX.conf 中引用规则文件
RULE-SET, https://raw.githubusercontent.com/SoultionLss/Rules/main/QuantumultX/AI/AI.list, AI
RULE-SET, https://raw.githubusercontent.com/SoultionLss/Rules/main/QuantumultX/Google/Google.list, Google
```
